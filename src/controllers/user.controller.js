...
const getUserChannel=asyncHandler(async(req,res,next)=>{
   ...
   try {
    ...
    const channel=await User.aggregate([
     ...
     {
         $project:{
             fullName:1,//selected value can be settled to 1
             username:1,
             subscribersCount:1,
 ...
 s
    ...
    .json(
     new ApiResponse(200,channel[0],"Channel fetched successfully")
        ...
        throw new ApiError(500,"Channel not fetched successfully")
   }
...
const getWatchHistory=asyncHandler(async(req,res,next)=>{ 
    try {
        ...
        throw new ApiError(500,"Watch history not fetched successfully")
...
export {registerUser,loginUser,logoutUser,refreshAccessToken ,changeCurrentPassword,getCurrentUser,updateAccount,updateUserAvator,
    updateUserCoverImage,getUserChannel,getWatchHistory};